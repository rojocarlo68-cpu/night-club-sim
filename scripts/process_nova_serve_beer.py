#!/usr/bin/env python3
"""Build nova_serve_beer_sheet.png: 8×146×784, gray bg → transparent."""
...
SRC = ATT / "b81b663ed7d5a1f03827e8f98e75a80586a4115606d45612e2841e65a8922def.jpeg"
ROOT = Path(__file__).resolve().parents[1]
DST = ROOT / "public/assets/characters/nova_serve_beer_sheet.png"
CUT = Path("/workspace/cutouts/nova_serve_beer_sheet.png")
...
def main() -> None:
    ...
    Image.fromarray(out, "RGBA").save(CUT, optimize=True)
